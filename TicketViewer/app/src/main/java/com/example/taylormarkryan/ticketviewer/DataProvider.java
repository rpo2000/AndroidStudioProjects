...
public class DataProvider{
    ...
    public static HashMap<String, List<String>> getInfo()
    {
        ...
        Story_Points.add("If two or more people try to edit a page simultaneously, the first one to save wins and the rest are notified that they can't save.");
        Story_Points.add("Merging your changes (technique 1)");
        Story_Points.add("This is simpler than technique 2, but risks losing your work: For a little while, your changes exist only in the clipboard.");
